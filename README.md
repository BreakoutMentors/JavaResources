...
| **Graphics Objects** | [GraphicsObjects.zip](https://github.com/BreakoutMentors/JavaResources/raw/main/GraphicsObjects.zip) | — | The starting point for Space Invaders, and a tour of how a game draws itself: an abstract `ScreenObject`, with `Oval` and `Image` extending it, and a 40-frames-per-second game loop. Plain Java Swing. |
